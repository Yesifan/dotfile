...
Bring a machine already running these dotfiles up to date. The path depends on whether the machine has a LOCAL commit, and whether the incoming change is breaking.
