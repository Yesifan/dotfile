...
- **Don't delete the canonical** unless intentional: removing `.codex/AGENTS.md` leaves a *dangling* opencode link (a broken path, not a deleted file). Recreate it with `ln -s ../../.codex/AGENTS.md .config/opencode/AGENTS.md`.
